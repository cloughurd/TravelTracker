...
public class NatParkPlottable implements IPlottable {
    private String label, latitude, longitude;
    private PlottableType type;
    private boolean visited;

    public NatParkPlottable(String label, String latitude, String longitude, boolean visited){
        this.label = label;
        this.latitude = latitude;
        this.longitude = longitude;
        this.visited = visited;
        type = PlottableType.NATIONAL_PARK;
    }
